  ...
  return (
    <div>
      ...
      <div className="mt-6 grid grid-cols-2 gap-4 lg:grid-cols-5">
        <StatWidget label={tStats("totalContent")} value={dashboardStats.totalContent} icon={Library} />
        <StatWidget label={tStats("publishedArticles")} value={dashboardStats.publishedArticles} icon={Newspaper} />
        <StatWidget label={tStats("lessons")} value={dashboardStats.lessons} icon={GraduationCap} />
        <StatWidget label={tStats("courses")} value={dashboardStats.courses} icon={PlayCircle} />
        <StatWidget label={tStats("users")} value={dashboardStats.users} icon={Users} />
      </div>
